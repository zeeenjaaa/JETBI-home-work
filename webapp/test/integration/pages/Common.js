sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblesssons/Marketplace-home-work-3/app", ".html");
		...
		return Opa5.extend("zjblesssons.Marketplace-home-work-3.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblesssons/Marketplace-home-work-3/localService/mockserver"], function (mockserver) {
